...
let virtual-env = "D:\Учеба\3 Курс\1 семестр\Паралельные вычечсления\PV2022SodaMachine\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Учеба\3 Курс\1 семестр\Паралельные вычечсления\PV2022SodaMachine\venv\Scripts\deactivate.nu"
